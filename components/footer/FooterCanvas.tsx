...
const FooterCanvas = () => {
  ...
  useEffect(() => {
    ...
    const images = [
      `${prefix}/footerIcons/AT-lifts.webp`,
      `${prefix}/footerIcons/AT.webp`,
      `${prefix}/footerIcons/CompMug.webp`,
      `${prefix}/footerIcons/CompSoc-laptop.webp`,
      `${prefix}/footerIcons/CompSock-pride.webp`,
      `${prefix}/footerIcons/CompSock.webp`,
      `${prefix}/footerIcons/AT-lifts.webp`,
      `${prefix}/footerIcons/AT.webp`,
      `${prefix}/footerIcons/CompMug.webp`,
      `${prefix}/footerIcons/CompSoc-laptop.webp`,
