...
const EventTileBig = ({
  ...
  return (
    <div
    className='bg-csgrey font-space-mono hover:bg-csred transition duration-500 ease-in-out border-2 border-white pt-6 pl-8 w-full h-full flex flex-col '
...
<h1 
  style={{ maxHeight: '80px', overflow: 'hidden', textOverflow: 'ellipsis',}} className='text-2xl w-3/4'>
     {title.toUpperCase()} </h1>
          <p className='mb-2 pt-4'>{date}, {location}</p>
        </div>
